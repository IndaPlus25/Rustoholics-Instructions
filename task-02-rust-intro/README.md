...
1) Create a repository named `<KTH_ID>-<task name>`. (ex. `dmitryc-task-2`)
2) Clone your newly created repository.
`git clone git@github.com:IndaPlus25/<KTH_ID>-<task name>.git`
...
- [Summera tal](https://kth.kattis.com/courses/DD2016/plusplus25/assignments/q4npcz/problems/kth.javap.sumsort)
- [Avstånd till kanten](https://kth.kattis.com/courses/DD2016/plusplus25/assignments/q4npcz/problems/kth.javap.kant)
- [Cyber-Clara och anmälningslistorna](https://kth.kattis.com/courses/DD2016/plusplus25/assignments/q4npcz/problems/kth.grupdat.anmalningslistorna)
